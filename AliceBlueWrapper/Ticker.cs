...
namespace AliceBlueWrapper
{
    public class Ticker
    {
        ...
        private string _root = "wss://ant.aliceblueonline.com/hydrasocket/v2/websocket";
        ...
        public Ticker( string AccessToken, string Root = null, bool Reconnect = false, int ReconnectInterval = 5, int ReconnectTries = 50, bool Debug = false, IWebSocket CustomWebSocket = null)
        {
            _debug = Debug;
            ...
            _socketUrl = _root + String.Format("?access_token={0}", _accessToken);
           ...
           //ThreadStart threadStart = new ThreadStart( SendHeartBeat);
           // threadStart.Invoke();
        }
        ...
        public void Subscribe(UInt32[] Tokens)
        {
            try
            {
                ...
                string msg = "{\"a\":\"subscribe\",\"v\":[2,39975],\"m\":\"marketdata\"}";
